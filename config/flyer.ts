export const flyerConfig = {
  organisationName: 'RCCG The Bridge Chicago', eventName: 'DWELL 2026: ELOHIM', eventSlug: 'dwell-2026', eventDate: 'Friday, August 28, 2026', eventTime: '6:00 PM CST', venue: 'RCCG Jesus House Chicago', address: '5224 N. Kedzie Avenue\nChicago, IL 60625', registrationUrl: 'https://thebridgechicago.org', canvasWidth: 1024, canvasHeight: 1536, artworkPath: '/event/dwell-2026-share-template.png',
  photoFrame: { x: 300, y: 607, width: 430, height: 528, cornerRadius: 54 },
